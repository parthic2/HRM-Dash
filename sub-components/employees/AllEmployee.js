...
const AllEmployee = () => {
  const { employeeData, isEditModalOpen, setIsEditModalOpen, editEmployeeId, handleEditButtonClick, deleteEmployee } = useEmployeeData();
                      ...
                      <td className="align-middle">
                        <div className="d-flex align-items-center">
                          <div className={`icon-shape icon-md border p-4 rounded-1`}>
                            {item.gov_doc && <Image src={item.gov_doc} alt="Gov Doc" width={35} />}
                          </div>
                        </div>
                      </td>
                      <td className="align-middle">
