...
import { Col, Card, Table, ProgressBar, Form } from 'react-bootstrap';
...
const AllProjects = () => {
  const { projectData, editProjectId, addProject, editProject, deleteProject, isEditModalOpen, setIsEditModalOpen, handleEditButtonClick, maxId } = useProjectData();
